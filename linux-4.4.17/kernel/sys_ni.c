...
/* memory tiering calls */
cond_syscall(sys_mtier_enqueue_process);
cond_syscall(sys_mtier_list);
cond_syscall(sys_mtier_kill_process);
cond_syscall(sys_do_mtier_management);
cond_syscall(sys_mtier_duplication_handler);
